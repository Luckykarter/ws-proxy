...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, application: str, client_id: int):
    ...
    def disconnect(self, websocket: WebSocket, application: str, client_id: int):
        self.active_connections[application][client_id].remove(websocket)

    async def broadcast(self, message: dict, application: str, client_id: int):
